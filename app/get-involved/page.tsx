    ...
    return (
        <div className="bg-black min-h-screen selection:bg-accent-blue selection:text-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 md:px-6 pt-24 md:pt-32 pb-24 relative z-10">
                ...
                <div className="container mx-auto px-4 md:px-6 pt-0 md:pt-32 pb-24 relative z-10 flex flex-col items-center justify-center min-h-[80vh]">
                    ...
                    <div className="text-center mb-12 space-y-6 max-w-2xl mx-auto">
                        ...
                        >
                            <span className="text-accent-blue/80 font-sans text-[10px] tracking-[0.3em] uppercase font-bold border border-accent-blue/20 px-3 py-1 rounded-sm inline-block mb-4">
                                Volunteer Now
                            </span>
                            ...
                            <p className="text-lg text-white/50 font-light leading-relaxed mt-4 max-w-lg mx-auto">
                                Stepwells Renovater is built on the hands and hearts of volunteers. Sign up below to join our next restoration drive.
                            </p>
                        </motion.div>
                    </div>

                    {/* The Application Form (Centered) */}
                    <div className="w-full max-w-3xl">
                        <div className="bg-white/[0.02] backdrop-blur-md rounded-[2.5rem] p-8 md:p-12 shadow-2xl border border-white/10 relative overflow-hidden">
                            {/* Decorative Glow */}
                            ...
                            <AnimatePresence mode="wait">
                                {submitted ? (
                                    ...
                                    >
                                        ...
                                        <h3 className="text-4xl font-serif font-light text-white mb-4">Welcome, Guardian.</h3>
                                    ...
                                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 relative z-10">
                                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 border-b border-white/10 pb-6">
                                            <h3 className="text-xl font-sans font-bold tracking-widest uppercase text-white flex items-center gap-3">
                                                <span className="w-2 h-2 bg-accent-blue rounded-full animate-pulse" />
                                                Application Form
                                            </h3>
                                            <span className="text-white/30 text-xs tracking-wider uppercase font-bold border border-white/10 px-2 py-1 rounded">Est. 2017</span>
                                        </div>
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div className="space-y-2 group">
                                                ...
                                                <input {...register("name")} className="w-full pb-2 text-lg border-b border-white/10 focus:border-accent-blue outline-none bg-transparent transition-all placeholder:text-white/10 text-white" placeholder="Caron Rawnsley" />
                                            ...
                                            <div className="space-y-2 group">
                                                ...
                                                <input {...register("city")} className="w-full pb-2 text-lg border-b border-white/10 focus:border-accent-blue outline-none bg-transparent transition-all placeholder:text-white/10 text-white" placeholder="Jodhpur, Rajasthan" />
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div className="space-y-2 group">
                                                ...
                                                <input {...register("email")} className="w-full pb-2 text-lg border-b border-white/10 focus:border-accent-blue outline-none bg-transparent transition-all placeholder:text-white/10 text-white" placeholder="guardian@email.com" />
                                            ...
                                            <div className="space-y-2 group">
                                                ...
                                                <input {...register("phone")} className="w-full pb-2 text-lg border-b border-white/10 focus:border-accent-blue outline-none bg-transparent transition-all placeholder:text-white/10 text-white" placeholder="+91 98765 43210" />
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                                {['weekends', 'weekdays', 'flexible'].map((opt) => (
                                                    <label key={opt} className="cursor-pointer group relative">
                                                        ...
                                                        <div className="text-center py-3 px-2 rounded-lg border border-white/10 bg-white/[0.02] text-white/60 peer-checked:bg-accent-blue peer-checked:text-black peer-checked:border-accent-blue peer-checked:font-bold hover:bg-white/5 transition-all text-sm capitalize">
                                                            {opt}
                                                        </div>
                                                    </label>
                                                ))}
                                        ...
                                        <div className="space-y-4 pt-4 border-t border-white/10">
                                            <div className="flex items-center gap-2 text-white/80 mb-2">
                                                ...
                                                <h4 className="text-sm font-bold uppercase tracking-wider">Terms & Conditions</h4>
                                            </div>

                                            <div className="h-48 overflow-y-auto pr-2 bg-black/40 rounded-xl border border-white/10 p-4 text-xs text-white/60 leading-relaxed font-mono space-y-4 custom-scrollbar">
                                            ...
                                            <label className="flex items-start gap-4 cursor-pointer group p-3 rounded-lg hover:bg-white/[0.02] transition-colors">
                                                <div className="relative flex items-center mt-0.5">
                                                    ...
                                                    />
                                                    <div className="w-5 h-5 border-2 border-white/30 rounded flex items-center justify-center peer-checked:bg-accent-blue peer-checked:border-accent-blue transition-all">
                                                        <Check size={14} className="text-black opacity-0 peer-checked:opacity-100" strokeWidth={3} />
                                                    </div>
                                                </div>
                                        ...
                                        <div className="pt-4">
                                            <Button
                                                ...
                                                className="w-full py-7 text-lg bg-accent-blue hover:bg-accent-blue-light text-black font-bold uppercase tracking-wider rounded-xl transition-all shadow-[0_0_20px_rgba(56,189,248,0.2)] hover:shadow-[0_0_30px_rgba(56,189,248,0.4)] hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"
                                            >
                                                {isSubmitting ? (
                                                    "Processing..."
                                                ) : (
                                            ...
                                            <p className="text-center text-[10px] tracking-widest uppercase text-white/30 mt-6 box-border">
